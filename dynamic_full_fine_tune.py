...
train_mask_1st=torch.hstack([train_mask_1st,torch.ones(1,2).squeeze(0).bool()])
train_mask_2nd=torch.hstack([train_mask,torch.ones(1,2).squeeze(0).bool()])
...
for epoch in range(450):
    ...
    loss = F.cross_entropy(logits[train_mask_1st], fake_node_labels[train_mask_1st])
...
for epoch in range(EPOCH):
    ...
    loss1 = F.cross_entropy(logits[train_mask_2nd], fake_node_labels[train_mask_2nd])
